...
public interface IImageManager {
    ...
    void setImageResource(ImageView imageView, int resId);
    ...
    void loadNet(String[] servers, String url, ImageView imageView);

    void downLoadImage(final Context context, final String[] url, final File targetFile, final ImageListener<File> imageListener);
}
