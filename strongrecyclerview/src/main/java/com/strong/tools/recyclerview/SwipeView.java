 ...
 * https://github.com/xytyl/SwipeView
 */
...
public class SwipeView extends ViewGroup {
    ...
    public SwipListener getmSwipListener() {
        return mSwipListener;
    }

    public void setSwipListener(SwipListener mSwipListener) {
        this.mSwipListener = mSwipListener;
    }
...
//                Log.i("SwipView", "Left " + getChildAt(0).getX());
                if (mSwipListener != null && mSwipListener.enableSwip()) {
